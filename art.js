...
// =====================================================
//
// Each divider has a central doorway.
//
...
function checkPlantCollision(
    ...
    for (
        const entry of collidableObjects
    ) {
